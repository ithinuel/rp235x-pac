...
#[doc = "Field `EHR_DATA3` reader - Bits \\[127:96\\] of Entropy Holding Register (EHR) - RNG output register"]
pub type EHR_DATA3_R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - Bits \\[127:96\\] of Entropy Holding Register (EHR) - RNG output register"]
    #[inline(always)]
