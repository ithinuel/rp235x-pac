...
#[doc = "Field `EHR_DATA0` reader - Bits \\[31:0\\] of Entropy Holding Register (EHR) - RNG output register"]
pub type EHR_DATA0_R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - Bits \\[31:0\\] of Entropy Holding Register (EHR) - RNG output register"]
    #[inline(always)]
