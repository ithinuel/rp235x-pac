...
#[doc = "Field `GPIO_OUT` reader - Set output level (1/0 -> high/low) for GPIO0...31. Reading back gives the last value written, NOT the input value from the pins.  
...
#[doc = "Field `GPIO_OUT` writer - Set output level (1/0 -> high/low) for GPIO0...31. Reading back gives the last value written, NOT the input value from the pins.  
...
impl R {
    #[doc = "Bits 0:31 - Set output level (1/0 -> high/low) for GPIO0...31. Reading back gives the last value written, NOT the input value from the pins.  
