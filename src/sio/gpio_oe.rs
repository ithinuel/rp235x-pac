...
#[doc = "Field `GPIO_OE` reader - Set output enable (1/0 -> output/input) for GPIO0...31. Reading back gives the last value written.  
...
#[doc = "Field `GPIO_OE` writer - Set output enable (1/0 -> output/input) for GPIO0...31. Reading back gives the last value written.  
...
impl R {
    #[doc = "Bits 0:31 - Set output enable (1/0 -> output/input) for GPIO0...31. Reading back gives the last value written.  
