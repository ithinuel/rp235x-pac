...
#[doc = "TIMEHW (w) register accessor: Write to bits 63:32 of time always write timelw before timehw  
...
pub mod timehw;
#[doc = "TIMELW (w) register accessor: Write to bits 31:0 of time writes do not get copied to time until timehw is written  
...
pub mod timelw;
#[doc = "TIMEHR (r) register accessor: Read from bits 63:32 of time always read timelr before timehr  
