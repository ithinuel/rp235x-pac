...
#[doc = "Field `NSU` reader - If 1, and NSP is also set, ADC0 can be accessed from a Non-secure, Unprivileged context.  
...
#[doc = "Field `NSU` writer - If 1, and NSP is also set, ADC0 can be accessed from a Non-secure, Unprivileged context.  
...
impl R {
    #[doc = "Bit 0 - If 1, and NSP is also set, ADC0 can be accessed from a Non-secure, Unprivileged context.  
