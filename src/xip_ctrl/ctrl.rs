...
#[doc = "Field `EN_SECURE` reader - When 1, enable the cache for Secure accesses. When enabled, Secure XIP accesses to the cached (addr\\[26\\] == 0) window will query the cache, and QSPI accesses are performed only if the requested data is not present. When disabled, Secure access ignore the cache contents, and always access the QSPI interface.  
...
#[doc = "Field `EN_NONSECURE` reader - When 1, enable the cache for Non-secure accesses. When enabled, Non-secure XIP accesses to the cached (addr\\[26\\] == 0) window will query the cache, and QSPI accesses are performed only if the requested data is not present. When disabled, Secure access ignore the cache contents, and always access the QSPI interface.  
...
#[doc = "Field `NO_UNCACHED_SEC` reader - When 1, Secure accesses to the uncached window (addr\\[27:26\\] == 1) will generate a bus error. This may reduce the number of SAU/MPU/PMP regions required to protect flash contents.  
...
#[doc = "Field `NO_UNCACHED_SEC` writer - When 1, Secure accesses to the uncached window (addr\\[27:26\\] == 1) will generate a bus error. This may reduce the number of SAU/MPU/PMP regions required to protect flash contents.  

 Note this does not disable access to the uncached, untranslated window -- see NO_UNTRANSLATED_SEC."]
pub type NO_UNCACHED_SEC_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `NO_UNCACHED_NONSEC` reader - When 1, Non-secure accesses to the uncached window (addr\\[27:26\\] == 1) will generate a bus error. This may reduce the number of SAU/MPU/PMP regions required to protect flash contents.  

 Note this does not disable access to the uncached, untranslated window -- see NO_UNTRANSLATED_SEC."]
pub type NO_UNCACHED_NONSEC_R = crate::BitReader;
#[doc = "Field `NO_UNCACHED_NONSEC` writer - When 1, Non-secure accesses to the uncached window (addr\\[27:26\\] == 1) will generate a bus error. This may reduce the number of SAU/MPU/PMP regions required to protect flash contents.  

 Note this does not disable access to the uncached, untranslated window -- see NO_UNTRANSLATED_SEC."]
pub type NO_UNCACHED_NONSEC_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `NO_UNTRANSLATED_SEC` reader - When 1, Secure accesses to the uncached, untranslated window (addr\\[27:26\\] == 3) will generate a bus error."]
pub type NO_UNTRANSLATED_SEC_R = crate::BitReader;
#[doc = "Field `NO_UNTRANSLATED_SEC` writer - When 1, Secure accesses to the uncached, untranslated window (addr\\[27:26\\] == 3) will generate a bus error."]
pub type NO_UNTRANSLATED_SEC_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `NO_UNTRANSLATED_NONSEC` reader - When 1, Non-secure accesses to the uncached, untranslated window (addr\\[27:26\\] == 3) will generate a bus error."]
pub type NO_UNTRANSLATED_NONSEC_R = crate::BitReader;
#[doc = "Field `NO_UNTRANSLATED_NONSEC` writer - When 1, Non-secure accesses to the uncached, untranslated window (addr\\[27:26\\] == 3) will generate a bus error."]
pub type NO_UNTRANSLATED_NONSEC_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `MAINT_NONSEC` reader - When 0, Non-secure accesses to the cache maintenance address window (addr\\[27\\] == 1, addr\\[26\\] == 0) will generate a bus error. When 1, Non-secure accesses can perform cache maintenance operations by writing to the cache maintenance address window.  
...
#[doc = "Field `MAINT_NONSEC` writer - When 0, Non-secure accesses to the cache maintenance address window (addr\\[27\\] == 1, addr\\[26\\] == 0) will generate a bus error. When 1, Non-secure accesses can perform cache maintenance operations by writing to the cache maintenance address window.  

 Cache maintenance operations may be used to corrupt Secure data by invalidating cache lines inappropriately, or map Secure content into a Non-secure region by pinning cache lines. Therefore this bit should generally be set to 0, unless Secure code is not using the cache.  

 Care should also be taken to clear the cache data memory and tag memory before granting maintenance operations to Non-secure code."]
pub type MAINT_NONSEC_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SPLIT_WAYS` reader - When 1, route all cached+Secure accesses to way 0 of the cache, and route all cached+Non-secure accesses to way 1 of the cache.  
...
#[doc = "Field `SPLIT_WAYS` writer - When 1, route all cached+Secure accesses to way 0 of the cache, and route all cached+Non-secure accesses to way 1 of the cache.  
...
impl R {
    #[doc = "Bit 0 - When 1, enable the cache for Secure accesses. When enabled, Secure XIP accesses to the cached (addr\\[26\\] == 0) window will query the cache, and QSPI accesses are performed only if the requested data is not present. When disabled, Secure access ignore the cache contents, and always access the QSPI interface.  
 ...
 There is no cache-as-SRAM address window. Cache lines are allocated for SRAM-like use by individually pinning them, and keeping the cache enabled."]
    ...
    #[doc = "Bit 1 - When 1, enable the cache for Non-secure accesses. When enabled, Non-secure XIP accesses to the cached (addr\\[26\\] == 0) window will query the cache, and QSPI accesses are performed only if the requested data is not present. When disabled, Secure access ignore the cache contents, and always access the QSPI interface.  
 ...
 Accesses to the uncached (addr\\[26\\] == 1) window will never query the cache, irrespective of this bit."]
    ...
    #[doc = "Bit 4 - When 1, Secure accesses to the uncached window (addr\\[27:26\\] == 1) will generate a bus error. This may reduce the number of SAU/MPU/PMP regions required to protect flash contents.  
 ...
 Note this does not disable access to the uncached, untranslated window -- see NO_UNTRANSLATED_SEC."]
    ...
    #[doc = "Bit 5 - When 1, Non-secure accesses to the uncached window (addr\\[27:26\\] == 1) will generate a bus error. This may reduce the number of SAU/MPU/PMP regions required to protect flash contents.  
 ...
 Note this does not disable access to the uncached, untranslated window -- see NO_UNTRANSLATED_SEC."]
    ...
    #[doc = "Bit 6 - When 1, Secure accesses to the uncached, untranslated window (addr\\[27:26\\] == 3) will generate a bus error."]
    #[inline(always)]
    pub fn no_untranslated_sec(&self) -> NO_UNTRANSLATED_SEC_R {
        NO_UNTRANSLATED_SEC_R::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - When 1, Non-secure accesses to the uncached, untranslated window (addr\\[27:26\\] == 3) will generate a bus error."]
    #[inline(always)]
    pub fn no_untranslated_nonsec(&self) -> NO_UNTRANSLATED_NONSEC_R {
        NO_UNTRANSLATED_NONSEC_R::new(((self.bits >> 7) & 1) != 0)
    }
    #[doc = "Bit 8 - When 0, Non-secure accesses to the cache maintenance address window (addr\\[27\\] == 1, addr\\[26\\] == 0) will generate a bus error. When 1, Non-secure accesses can perform cache maintenance operations by writing to the cache maintenance address window.  
 ...
 Care should also be taken to clear the cache data memory and tag memory before granting maintenance operations to Non-secure code."]
    ...
    #[doc = "Bit 9 - When 1, route all cached+Secure accesses to way 0 of the cache, and route all cached+Non-secure accesses to way 1 of the cache.  
