...
#[doc = "Field `CTR_ACC` reader - A 32 bit saturating counter that increments upon each XIP access,   
 whether the cache is hit or not. This includes noncacheable accesses.   
 Write any value to clear."]
pub type CTR_ACC_R = crate::FieldReader<u32>;
#[doc = "Field `CTR_ACC` writer - A 32 bit saturating counter that increments upon each XIP access,   
 whether the cache is hit or not. This includes noncacheable accesses.   
 Write any value to clear."]
pub type CTR_ACC_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - A 32 bit saturating counter that increments upon each XIP access,   
 whether the cache is hit or not. This includes noncacheable accesses.   
 Write any value to clear."]
    #[inline(always)]
