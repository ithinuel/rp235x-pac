...
#[doc = "Field `CTR_HIT` reader - A 32 bit saturating counter that increments upon each cache hit,   
 i.e. when an XIP access is serviced directly from cached data.   
 Write any value to clear."]
pub type CTR_HIT_R = crate::FieldReader<u32>;
#[doc = "Field `CTR_HIT` writer - A 32 bit saturating counter that increments upon each cache hit,   
 i.e. when an XIP access is serviced directly from cached data.   
 Write any value to clear."]
pub type CTR_HIT_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - A 32 bit saturating counter that increments upon each cache hit,   
 i.e. when an XIP access is serviced directly from cached data.   
 Write any value to clear."]
    #[inline(always)]
