...
For information about available fields see [`mod@linestate_tuning`] module"]
...
For information about available fields see [`mod@sof_timestamp_raw`] module"]
...
#[doc = "SOF_TIMESTAMP_LAST (r) register accessor: Device only. Value of free-running PHY clock counter @48MHz when last SOF event occurred.  
...
For information about available fields see [`mod@sof_timestamp_last`] module"]
...
For information about available fields see [`mod@sm_state`] module"]
...
For information about available fields see [`mod@ep_tx_error`] module"]
...
For information about available fields see [`mod@ep_rx_error`] module"]
...
For information about available fields see [`mod@dev_sm_watchdog`] module"]
