...
#[doc = "This is used to save power by pausing the ROSC   
...
#[doc = "Field `DORMANT` reader - This is used to save power by pausing the ROSC   
 On power-up this field is initialised to WAKE   
 An invalid write will also select WAKE   
 Warning: setup the irq before selecting dormant mode"]
...
#[doc = "Field `DORMANT` writer - This is used to save power by pausing the ROSC   
 On power-up this field is initialised to WAKE   
 An invalid write will also select WAKE   
 Warning: setup the irq before selecting dormant mode"]
...
impl R {
    #[doc = "Bits 0:31 - This is used to save power by pausing the ROSC   
 On power-up this field is initialised to WAKE   
 An invalid write will also select WAKE   
 Warning: setup the irq before selecting dormant mode"]
    #[inline(always)]
