...
#[doc = "Field `HAD_WATCHDOG_RESET_RSM` reader - Last reset was a watchdog timeout which was configured to reset the power-on state machine   
 This resets:   
 double_tap flag no   
 DP no   
 RPAP no   
...
impl R {
 ...
 and does not change the power state"]
    ...
    #[doc = "Bit 28 - Last reset was a watchdog timeout which was configured to reset the power-on state machine   
 This resets:   
 double_tap flag no   
 DP no   
 RPAP no   
