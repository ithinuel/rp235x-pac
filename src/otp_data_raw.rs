...
impl RegisterBlock {
    #[doc = "0x00 - Bits 15:0 of public device ID. (ECC)  
 ...
 The number of random bits makes the occurrence of twins exceedingly unlikely: for example, a fleet of a hundred million devices has a 99.97% probability of no twinned IDs. This is estimated to be lower than the occurrence of process errors in the assignment of sequential random IDs, and for practical purposes CHIPID may be treated as unique."]
    ...
    #[doc = "0x10 - Bits 15:0 of private per-device random number (ECC)  
 ...
 This ID is not exposed through the USB PICOBOOT GET_INFO command or the ROM `get_sys_info()` API. However note that the USB PICOBOOT OTP access point can read the entirety of page 0, so this value is not meaningfully private unless the USB PICOBOOT interface is disabled via the DISABLE_BOOTSEL_USB_PICOBOOT_IFC flag in BOOT_FLAGS0."]
    ...
    #[doc = "0x40 - Ring oscillator frequency in kHz, measured during manufacturing (ECC)  
 ...
 This is measured at 1.1 V, at room temperature, with the ROSC configuration registers in their reset state."]
    ...
    #[doc = "0x44 - Low-power oscillator frequency in Hz, measured during manufacturing (ECC)  
 ...
 This is measured at 1.1V, at room temperature, with the LPOSC trim register in its reset state."]
    ...
    #[doc = "0x150 - Stores information about external flash device(s). (ECC)  
 ...
 Assumed to be valid if BOOT_FLAGS0_FLASH_DEVINFO_ENABLE is set."]
    ...
    #[doc = "0x158 - Pin configuration for LED status, used by USB bootloader. (ECC)   
 Must be valid if BOOT_FLAGS0_ENABLE_BOOTSEL_LED is set."]
    ...
    #[doc = "0x15c - Optional PLL configuration for BOOTSEL mode. (ECC)  
 ...
 Used if and only if ENABLE_BOOTSEL_NON_DEFAULT_PLL_XOSC_CFG is set in BOOT_FLAGS0. That bit should be set only after this row and BOOTSEL_PLL_CFG are both correctly programmed."]
    ...
    #[doc = "0x170 - Row index of the USB_WHITE_LABEL structure within OTP (ECC)  
 ...
 The index values indicate where each field is located (row USB_WHITE_LABEL_ADDR value + index):"]
    ...
    #[doc = "0x178 - OTP start row for the OTP boot image. (ECC)  
 ...
 This must be an even number. Equivalently, the OTP boot image must start at a word-aligned location in the ECC read data address window."]
    ...
    #[doc = "0x17c - Length in rows of the OTP boot image. (ECC)  
 ...
 OTPBOOT_LEN must be even. The total image size must be a multiple of 4 bytes (32 bits)."]
    ...
    #[doc = "0x180 - Bits 15:0 of the OTP boot image load destination (and entry point). (ECC)  
 ...
 This must be a location in main SRAM (main SRAM is addresses 0x20000000 through 0x20082000) and must be word-aligned."]
    ...
    #[doc = "0x184 - Bits 31:16 of the OTP boot image load destination (and entry point). (ECC)  
 ...
 This must be a location in main SRAM (main SRAM is addresses 0x20000000 through 0x20082000) and must be word-aligned."]
    ...
    #[doc = "0x3e00 - Lock configuration LSBs for page 0 (rows 0x0 through 0x3f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3e04 - Lock configuration MSBs for page 0 (rows 0x0 through 0x3f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3e08 - Lock configuration LSBs for page 1 (rows 0x40 through 0x7f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3e0c - Lock configuration MSBs for page 1 (rows 0x40 through 0x7f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3e10 - Lock configuration LSBs for page 2 (rows 0x80 through 0xbf). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3e14 - Lock configuration MSBs for page 2 (rows 0x80 through 0xbf). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3e18 - Lock configuration LSBs for page 3 (rows 0xc0 through 0xff). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3e1c - Lock configuration MSBs for page 3 (rows 0xc0 through 0xff). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3e20 - Lock configuration LSBs for page 4 (rows 0x100 through 0x13f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3e24 - Lock configuration MSBs for page 4 (rows 0x100 through 0x13f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3e28 - Lock configuration LSBs for page 5 (rows 0x140 through 0x17f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3e2c - Lock configuration MSBs for page 5 (rows 0x140 through 0x17f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3e30 - Lock configuration LSBs for page 6 (rows 0x180 through 0x1bf). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3e34 - Lock configuration MSBs for page 6 (rows 0x180 through 0x1bf). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3e38 - Lock configuration LSBs for page 7 (rows 0x1c0 through 0x1ff). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3e3c - Lock configuration MSBs for page 7 (rows 0x1c0 through 0x1ff). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3e40 - Lock configuration LSBs for page 8 (rows 0x200 through 0x23f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3e44 - Lock configuration MSBs for page 8 (rows 0x200 through 0x23f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3e48 - Lock configuration LSBs for page 9 (rows 0x240 through 0x27f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3e4c - Lock configuration MSBs for page 9 (rows 0x240 through 0x27f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3e50 - Lock configuration LSBs for page 10 (rows 0x280 through 0x2bf). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3e54 - Lock configuration MSBs for page 10 (rows 0x280 through 0x2bf). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3e58 - Lock configuration LSBs for page 11 (rows 0x2c0 through 0x2ff). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3e5c - Lock configuration MSBs for page 11 (rows 0x2c0 through 0x2ff). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3e60 - Lock configuration LSBs for page 12 (rows 0x300 through 0x33f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3e64 - Lock configuration MSBs for page 12 (rows 0x300 through 0x33f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3e68 - Lock configuration LSBs for page 13 (rows 0x340 through 0x37f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3e6c - Lock configuration MSBs for page 13 (rows 0x340 through 0x37f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3e70 - Lock configuration LSBs for page 14 (rows 0x380 through 0x3bf). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3e74 - Lock configuration MSBs for page 14 (rows 0x380 through 0x3bf). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3e78 - Lock configuration LSBs for page 15 (rows 0x3c0 through 0x3ff). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3e7c - Lock configuration MSBs for page 15 (rows 0x3c0 through 0x3ff). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3e80 - Lock configuration LSBs for page 16 (rows 0x400 through 0x43f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3e84 - Lock configuration MSBs for page 16 (rows 0x400 through 0x43f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3e88 - Lock configuration LSBs for page 17 (rows 0x440 through 0x47f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3e8c - Lock configuration MSBs for page 17 (rows 0x440 through 0x47f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3e90 - Lock configuration LSBs for page 18 (rows 0x480 through 0x4bf). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3e94 - Lock configuration MSBs for page 18 (rows 0x480 through 0x4bf). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3e98 - Lock configuration LSBs for page 19 (rows 0x4c0 through 0x4ff). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3e9c - Lock configuration MSBs for page 19 (rows 0x4c0 through 0x4ff). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3ea0 - Lock configuration LSBs for page 20 (rows 0x500 through 0x53f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3ea4 - Lock configuration MSBs for page 20 (rows 0x500 through 0x53f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3ea8 - Lock configuration LSBs for page 21 (rows 0x540 through 0x57f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3eac - Lock configuration MSBs for page 21 (rows 0x540 through 0x57f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3eb0 - Lock configuration LSBs for page 22 (rows 0x580 through 0x5bf). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3eb4 - Lock configuration MSBs for page 22 (rows 0x580 through 0x5bf). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3eb8 - Lock configuration LSBs for page 23 (rows 0x5c0 through 0x5ff). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3ebc - Lock configuration MSBs for page 23 (rows 0x5c0 through 0x5ff). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3ec0 - Lock configuration LSBs for page 24 (rows 0x600 through 0x63f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3ec4 - Lock configuration MSBs for page 24 (rows 0x600 through 0x63f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3ec8 - Lock configuration LSBs for page 25 (rows 0x640 through 0x67f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3ecc - Lock configuration MSBs for page 25 (rows 0x640 through 0x67f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3ed0 - Lock configuration LSBs for page 26 (rows 0x680 through 0x6bf). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3ed4 - Lock configuration MSBs for page 26 (rows 0x680 through 0x6bf). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3ed8 - Lock configuration LSBs for page 27 (rows 0x6c0 through 0x6ff). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3edc - Lock configuration MSBs for page 27 (rows 0x6c0 through 0x6ff). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3ee0 - Lock configuration LSBs for page 28 (rows 0x700 through 0x73f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3ee4 - Lock configuration MSBs for page 28 (rows 0x700 through 0x73f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3ee8 - Lock configuration LSBs for page 29 (rows 0x740 through 0x77f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3eec - Lock configuration MSBs for page 29 (rows 0x740 through 0x77f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3ef0 - Lock configuration LSBs for page 30 (rows 0x780 through 0x7bf). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3ef4 - Lock configuration MSBs for page 30 (rows 0x780 through 0x7bf). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3ef8 - Lock configuration LSBs for page 31 (rows 0x7c0 through 0x7ff). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3efc - Lock configuration MSBs for page 31 (rows 0x7c0 through 0x7ff). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3f00 - Lock configuration LSBs for page 32 (rows 0x800 through 0x83f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3f04 - Lock configuration MSBs for page 32 (rows 0x800 through 0x83f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3f08 - Lock configuration LSBs for page 33 (rows 0x840 through 0x87f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3f0c - Lock configuration MSBs for page 33 (rows 0x840 through 0x87f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3f10 - Lock configuration LSBs for page 34 (rows 0x880 through 0x8bf). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3f14 - Lock configuration MSBs for page 34 (rows 0x880 through 0x8bf). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3f18 - Lock configuration LSBs for page 35 (rows 0x8c0 through 0x8ff). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3f1c - Lock configuration MSBs for page 35 (rows 0x8c0 through 0x8ff). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3f20 - Lock configuration LSBs for page 36 (rows 0x900 through 0x93f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3f24 - Lock configuration MSBs for page 36 (rows 0x900 through 0x93f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3f28 - Lock configuration LSBs for page 37 (rows 0x940 through 0x97f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3f2c - Lock configuration MSBs for page 37 (rows 0x940 through 0x97f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3f30 - Lock configuration LSBs for page 38 (rows 0x980 through 0x9bf). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3f34 - Lock configuration MSBs for page 38 (rows 0x980 through 0x9bf). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3f38 - Lock configuration LSBs for page 39 (rows 0x9c0 through 0x9ff). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3f3c - Lock configuration MSBs for page 39 (rows 0x9c0 through 0x9ff). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3f40 - Lock configuration LSBs for page 40 (rows 0xa00 through 0xa3f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3f44 - Lock configuration MSBs for page 40 (rows 0xa00 through 0xa3f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3f48 - Lock configuration LSBs for page 41 (rows 0xa40 through 0xa7f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3f4c - Lock configuration MSBs for page 41 (rows 0xa40 through 0xa7f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3f50 - Lock configuration LSBs for page 42 (rows 0xa80 through 0xabf). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3f54 - Lock configuration MSBs for page 42 (rows 0xa80 through 0xabf). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3f58 - Lock configuration LSBs for page 43 (rows 0xac0 through 0xaff). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3f5c - Lock configuration MSBs for page 43 (rows 0xac0 through 0xaff). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3f60 - Lock configuration LSBs for page 44 (rows 0xb00 through 0xb3f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3f64 - Lock configuration MSBs for page 44 (rows 0xb00 through 0xb3f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3f68 - Lock configuration LSBs for page 45 (rows 0xb40 through 0xb7f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3f6c - Lock configuration MSBs for page 45 (rows 0xb40 through 0xb7f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3f70 - Lock configuration LSBs for page 46 (rows 0xb80 through 0xbbf). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3f74 - Lock configuration MSBs for page 46 (rows 0xb80 through 0xbbf). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3f78 - Lock configuration LSBs for page 47 (rows 0xbc0 through 0xbff). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3f7c - Lock configuration MSBs for page 47 (rows 0xbc0 through 0xbff). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3f80 - Lock configuration LSBs for page 48 (rows 0xc00 through 0xc3f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3f84 - Lock configuration MSBs for page 48 (rows 0xc00 through 0xc3f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3f88 - Lock configuration LSBs for page 49 (rows 0xc40 through 0xc7f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3f8c - Lock configuration MSBs for page 49 (rows 0xc40 through 0xc7f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3f90 - Lock configuration LSBs for page 50 (rows 0xc80 through 0xcbf). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3f94 - Lock configuration MSBs for page 50 (rows 0xc80 through 0xcbf). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3f98 - Lock configuration LSBs for page 51 (rows 0xcc0 through 0xcff). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3f9c - Lock configuration MSBs for page 51 (rows 0xcc0 through 0xcff). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3fa0 - Lock configuration LSBs for page 52 (rows 0xd00 through 0xd3f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3fa4 - Lock configuration MSBs for page 52 (rows 0xd00 through 0xd3f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3fa8 - Lock configuration LSBs for page 53 (rows 0xd40 through 0xd7f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3fac - Lock configuration MSBs for page 53 (rows 0xd40 through 0xd7f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3fb0 - Lock configuration LSBs for page 54 (rows 0xd80 through 0xdbf). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3fb4 - Lock configuration MSBs for page 54 (rows 0xd80 through 0xdbf). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3fb8 - Lock configuration LSBs for page 55 (rows 0xdc0 through 0xdff). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3fbc - Lock configuration MSBs for page 55 (rows 0xdc0 through 0xdff). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3fc0 - Lock configuration LSBs for page 56 (rows 0xe00 through 0xe3f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3fc4 - Lock configuration MSBs for page 56 (rows 0xe00 through 0xe3f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3fc8 - Lock configuration LSBs for page 57 (rows 0xe40 through 0xe7f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3fcc - Lock configuration MSBs for page 57 (rows 0xe40 through 0xe7f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3fd0 - Lock configuration LSBs for page 58 (rows 0xe80 through 0xebf). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3fd4 - Lock configuration MSBs for page 58 (rows 0xe80 through 0xebf). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3fd8 - Lock configuration LSBs for page 59 (rows 0xec0 through 0xeff). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3fdc - Lock configuration MSBs for page 59 (rows 0xec0 through 0xeff). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3fe0 - Lock configuration LSBs for page 60 (rows 0xf00 through 0xf3f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3fe4 - Lock configuration MSBs for page 60 (rows 0xf00 through 0xf3f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3fe8 - Lock configuration LSBs for page 61 (rows 0xf40 through 0xf7f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3fec - Lock configuration MSBs for page 61 (rows 0xf40 through 0xf7f). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3ff0 - Lock configuration LSBs for page 62 (rows 0xf80 through 0xfbf). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3ff4 - Lock configuration MSBs for page 62 (rows 0xf80 through 0xfbf). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3ff8 - Lock configuration LSBs for page 63 (rows 0xfc0 through 0xfff). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
 ...
 This OTP location is always readable, and is write-protected by its own permissions."]
    ...
    #[doc = "0x3ffc - Lock configuration MSBs for page 63 (rows 0xfc0 through 0xfff). Locks are stored with 3-way majority vote encoding, so that bits can be set independently.  
...
#[doc = "CHIPID0 (r) register accessor: Bits 15:0 of public device ID. (ECC)  
...
#[doc = "Bits 15:0 of public device ID. (ECC)  
 ...
 The number of random bits makes the occurrence of twins exceedingly unlikely: for example, a fleet of a hundred million devices has a 99.97% probability of no twinned IDs. This is estimated to be lower than the occurrence of process errors in the assignment of sequential random IDs, and for practical purposes CHIPID may be treated as unique."]
pub mod chipid0;
#[doc = "CHIPID1 (r) register accessor: Bits 31:16 of public device ID (ECC)  
...
pub mod chipid1;
#[doc = "CHIPID2 (r) register accessor: Bits 47:32 of public device ID (ECC)  
...
pub mod chipid2;
#[doc = "CHIPID3 (r) register accessor: Bits 63:48 of public device ID (ECC)  
...
pub mod chipid3;
#[doc = "RANDID0 (r) register accessor: Bits 15:0 of private per-device random number (ECC)  
...
#[doc = "Bits 15:0 of private per-device random number (ECC)  
 ...
 This ID is not exposed through the USB PICOBOOT GET_INFO command or the ROM `get_sys_info()` API. However note that the USB PICOBOOT OTP access point can read the entirety of page 0, so this value is not meaningfully private unless the USB PICOBOOT interface is disabled via the DISABLE_BOOTSEL_USB_PICOBOOT_IFC flag in BOOT_FLAGS0."]
pub mod randid0;
#[doc = "RANDID1 (r) register accessor: Bits 31:16 of private per-device random number (ECC)  
...
pub mod randid1;
#[doc = "RANDID2 (r) register accessor: Bits 47:32 of private per-device random number (ECC)  
...
pub mod randid2;
#[doc = "RANDID3 (r) register accessor: Bits 63:48 of private per-device random number (ECC)  
...
pub mod randid3;
#[doc = "RANDID4 (r) register accessor: Bits 79:64 of private per-device random number (ECC)  
...
pub mod randid4;
#[doc = "RANDID5 (r) register accessor: Bits 95:80 of private per-device random number (ECC)  
...
pub mod randid5;
#[doc = "RANDID6 (r) register accessor: Bits 111:96 of private per-device random number (ECC)  
...
pub mod randid6;
#[doc = "RANDID7 (r) register accessor: Bits 127:112 of private per-device random number (ECC)  
...
pub mod randid7;
#[doc = "ROSC_CALIB (r) register accessor: Ring oscillator frequency in kHz, measured during manufacturing (ECC)  
...
#[doc = "Ring oscillator frequency in kHz, measured during manufacturing (ECC)  
 ...
 This is measured at 1.1 V, at room temperature, with the ROSC configuration registers in their reset state."]
pub mod rosc_calib;
#[doc = "LPOSC_CALIB (r) register accessor: Low-power oscillator frequency in Hz, measured during manufacturing (ECC)  
...
#[doc = "Low-power oscillator frequency in Hz, measured during manufacturing (ECC)  
 ...
 This is measured at 1.1V, at room temperature, with the LPOSC trim register in its reset state."]
pub mod lposc_calib;
#[doc = "NUM_GPIOS (r) register accessor: The number of main user GPIOs (bank 0). Should read 48 in the QFN80 package, and 30 in the QFN60 package. (ECC)  
