...
#[doc = "Set when a detector output triggers. Write-1-clear.  
 ...
 This register is Secure read/write only."]
pub mod trig_status;
#[doc = "TRIG_FORCE (w) register accessor: Simulate the firing of one or more detectors. Writing ones to this register will set the matching bits in STATUS_TRIG.  
