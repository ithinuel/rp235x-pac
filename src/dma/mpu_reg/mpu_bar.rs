...
You can [`read`](crate::Reg::read) this register and get [`mpu_bar::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mpu_bar::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MPU_BAR_SPEC;
impl crate::RegisterSpec for MPU_BAR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mpu_bar::R`](R) reader structure"]
impl crate::Readable for MPU_BAR_SPEC {}
