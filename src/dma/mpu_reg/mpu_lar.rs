#[doc = "Register `MPU_LAR` reader"]
pub type R = crate::R<MPU_LAR_SPEC>;
#[doc = "Register `MPU_LAR` writer"]
pub type W = crate::W<MPU_LAR_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`mpu_lar::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mpu_lar::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MPU_LAR_SPEC;
impl crate::RegisterSpec for MPU_LAR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mpu_lar::R`](R) reader structure"]
impl crate::Readable for MPU_LAR_SPEC {}
