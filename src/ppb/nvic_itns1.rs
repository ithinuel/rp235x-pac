...
#[doc = "Field `ITNS` reader - For ITNS\\[m\\] in NVIC_ITNS*n, `IAAMO the target Security state for interrupt 32*n+m"]
pub type ITNS_R = crate::FieldReader<u32>;
#[doc = "Field `ITNS` writer - For ITNS\\[m\\] in NVIC_ITNS*n, `IAAMO the target Security state for interrupt 32*n+m"]
pub type ITNS_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - For ITNS\\[m\\] in NVIC_ITNS*n, `IAAMO the target Security state for interrupt 32*n+m"]
    #[inline(always)]
