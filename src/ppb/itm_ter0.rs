...
#[doc = "Field `STIMENA` reader - For STIMENA\\[m\\] in ITM_TER*n, controls whether ITM_STIM(32*n + m) is enabled"]
pub type STIMENA_R = crate::FieldReader<u32>;
#[doc = "Field `STIMENA` writer - For STIMENA\\[m\\] in ITM_TER*n, controls whether ITM_STIM(32*n + m) is enabled"]
pub type STIMENA_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - For STIMENA\\[m\\] in ITM_TER*n, controls whether ITM_STIM(32*n + m) is enabled"]
    #[inline(always)]
