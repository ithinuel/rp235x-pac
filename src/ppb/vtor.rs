...
#[doc = "Field `TBLOFF` reader - Vector table base offset field. It contains bits\\[31:7\\] of the offset of the table base from the bottom of the memory map."]
pub type TBLOFF_R = crate::FieldReader<u32>;
#[doc = "Field `TBLOFF` writer - Vector table base offset field. It contains bits\\[31:7\\] of the offset of the table base from the bottom of the memory map."]
pub type TBLOFF_W<'a, REG> = crate::FieldWriter<'a, REG, 25, u32>;
impl R {
    #[doc = "Bits 7:31 - Vector table base offset field. It contains bits\\[31:7\\] of the offset of the table base from the bottom of the memory map."]
    #[inline(always)]
