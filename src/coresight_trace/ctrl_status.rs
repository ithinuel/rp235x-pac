...
#[doc = "Field `TRACE_CAPTURE_FIFO_FLUSH` reader - Set to 1 to continuously hold the trace FIFO in a flushed state and prevent overflow.  
...
#[doc = "Field `TRACE_CAPTURE_FIFO_FLUSH` writer - Set to 1 to continuously hold the trace FIFO in a flushed state and prevent overflow.  
...
impl R {
    #[doc = "Bit 0 - Set to 1 to continuously hold the trace FIFO in a flushed state and prevent overflow.  
