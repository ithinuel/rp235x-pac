...
#[doc = "Field `RDATA` reader - Read from an 8 x 32-bit FIFO containing trace data captured from the TPIU.  
...
impl R {
    #[doc = "Bits 0:31 - Read from an 8 x 32-bit FIFO containing trace data captured from the TPIU.  
